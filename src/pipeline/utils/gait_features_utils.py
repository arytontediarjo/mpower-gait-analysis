...
class GaitFeaturize:
    ...
    def get_sensor_data(self, data, sensor):
        ...
        Args:
            data     (dtype: string, pd.DataFrame): filepath or dataframe
            sensor   (dtype: string)              : sensor type

        Returns:
            Rtype: pd.DataFrame, or string error messages
            Return a formatted version of the dataframe that contains formatted
            time-series of sensor data or error message

        Return Column Format:
            [timestamp (DateTimeIndexindex), x, y, z, AA, td]
        """
    ...
    def run_gait_feature_pipeline(self, data):
        ...
        Args:
            data (dtype: dataframe or string filepath): filepath or raw
        ...
        resampled_rotation = self._resample_signal(rotation_data)
        resampled_accel = self._resample_signal(accel_data)
